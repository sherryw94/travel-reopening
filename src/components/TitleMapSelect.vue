    ...
    <div class="main-container">
      <div class="main-container__inner">
        <div class="mb-4 sm:mb-6 lg:mb-8">
          ...
          <div class="flex flex-col items-baseline sm:justify-between sm:flex-row mb-2 sm:mb-4">
            <div class="sm:order-last mb-3 sm:my-0">
              <div class="flex flex-col">
                <ProductHuntBadge class="mb-4 sm:mt-4 sm:mb-0 sm:ml-5" />
                <ShareNetwork class="sm:order-first" />
              </div>
            </div>
            <div class="w-full md:w-9/12 sm:order-first">
              <p>
